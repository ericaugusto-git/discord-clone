...
CREATE TABLE `Direct` (
    `id` VARCHAR(191) NOT NULL,
    `profileOneId` VARCHAR(191) NOT NULL,
    `profileTwoId` VARCHAR(191) NOT NULL,

    INDEX `Direct_profileTwoId_idx`(`profileTwoId`),
    UNIQUE INDEX `Direct_profileOneId_profileTwoId_key`(`profileOneId`, `profileTwoId`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `DirectMessage` (
    ...
    `fileUrl` TEXT NULL,
    `profileId` VARCHAR(191) NOT NULL,
    `directId` VARCHAR(191) NOT NULL,
    `deleted` BOOLEAN NOT NULL DEFAULT false,
    `createdAt` DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
    `updatedAt` DATETIME(3) NOT NULL,

    INDEX `DirectMessage_profileId_idx`(`profileId`),
    INDEX `DirectMessage_directId_idx`(`directId`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
