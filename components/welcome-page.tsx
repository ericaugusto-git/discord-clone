...
export default function WelcomePage ({profile}: {profile: Profile}){
    ...
    return (
        <div className="w-full h-full flex justify-center items-center flex-col gap-3">
            ...
            <div className="text-center text-[#b4b4b4] text-sm px-4">
                ...
                <p>Please avoid uploading any sensitive information, as ITS NOT PRIVATE.</p>
            ...
            <div className="flex gap-3">
                <button className="border rounded-full px-4 bg-white  text-black p-2 hover:opacity-90" onClick={() => onOpen("invite", {inviteLink: `/directs/direct/${profile.id}`})}>Invite someone to chat</button>
                <button  className="border rounded-full px-4 hover:bg-slate-50/10 border-[#AEBBC1] p-2" onClick={() => onOpen("createServer")}>Create a server</button>
            </div>
        </div>
    );
}
