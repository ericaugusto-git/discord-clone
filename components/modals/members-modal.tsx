                ...
                <ScrollArea className="mt-8 max-h-[420px] pr-6">
                    {server?.members?.map((member) => (
                        <div key={member.id} className="flex items-center gap-x-2 mb-6">
                            <UserAvatar name={member.profile.username} src={member.profile.imageUrl!}/>
                                ...
                                <div className="ml-auto">
                                    <DropdownMenu>
                                        ...
                                        <DropdownMenuContent side="left">
                                            ...
                                            <DropdownMenuItem onClick={() => onKick(member.id)} className="text-red-500">
                            ...
                            {loadingId === member.id && (
                                        <Loader2 className="animate-spin flex-grow-0 text-zinc-500 ml-auto w-4 h-4"/>
                            )}
                        </div>
